...
/**
 * 定义：
 * 在三维空间中，这是一个球体，它以最小的半径包围一个或多个对象，具体来说就是由一个中心点和一个半径定义的球体
 *
 * 用途：
 * 主要用途包括碰撞检测、视锥裁剪、层次包围体等。在计算机图形学中，这些用途帮助提高性能和效率
 *
 * @type {module:@cesium/engine.BoundingSphere}
 */
const boundingSphereScratch = new BoundingSphere();


/**
 * 处理时间轴拖动事件。具体来说，当时间轴被拖动时，它会更新与时间轴关联的时钟对象的当前时间，并停止时钟的动画。
 * @param e
 */
